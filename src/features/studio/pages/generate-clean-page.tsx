            ...
            <Card className="bg-amber-500/10 border-amber-500/20">
              <CardContent className="pt-4">
                <p className="text-sm text-amber-200">
                  ...
                  bubbles. After generating, click on any panel to open the
                  Dialogue Editor where you can add speech bubbles anywhere you
                  want!
                </p>
              </CardContent>
            </Card>
                ...
                {generatedImages.length > 0 ? (
                  ...
                  <div className="h-96 flex flex-col items-center justify-center text-zinc-500">
                    ...
                    <p className="text-sm text-center max-w-md">
                      Describe your scene and click &quot;Generate Clean
                      Panels&quot; to create manga panels without dialogue
                      bubbles.
                    </p>
                  </div>
                )}
