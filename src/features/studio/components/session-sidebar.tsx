...
export default function SessionSidebar({
  ...
  const isReferencePage = (pageId: string) =>
    selectedReferencePageIds.includes(pageId);
                ...
                <div className="absolute top-2 left-2 flex items-center gap-1.5">
                  ...
                  {onToggleReferencePage && (
                    <button
                      ...
                      title={
                        isReferencePage(page.id)
                          ? 'Remove from reference (used for continuation)'
                ...
                <div className="absolute bottom-0 left-0 right-0 p-2 pb-3 bg-gradient-to-t from-black/90 to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                  <div className="flex gap-1 mb-0.5">
                    ...
                    <button
                      ...
                      className="p-1.5 bg-gradient-to-b from-zinc-600 to-zinc-800 rounded text-white transition-all text-xs shadow-[0_2px_0_0_rgb(39,39,42)] active:translate-y-0.5"
                    >
                      ▲
                    </button>
                    <button
