...
export const StudioMobileSidebar = () => {
  ...
  return (
    <>
      ...
      />
      <div className="fixed left-0 top-16 bottom-0 w-[85vw] max-w-sm bg-zinc-900 border-r border-zinc-800 z-50 md:hidden flex flex-col shadow-2xl animate-in slide-in-from-left duration-300">
