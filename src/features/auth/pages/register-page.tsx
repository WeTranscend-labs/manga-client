...
export function RegisterPage(_props: any) {
  ...
  return (
    <div className="min-h-screen px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
      <div>
        {/* Logo SVG */}
        ...
        <p
          ...
          style={{ fontFamily: 'var(--font-inter)' }}
        >
          We empower creators and artists to create, design, and manage
          AI-driven manga stories visually
        </p>
