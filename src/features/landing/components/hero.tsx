...
export function Hero() {
  ...
  const images = Array.from(
    { length: 32 },
    (_, i) => baseMangaImages[i % baseMangaImages.length],
  );
    ...
    <section className=" my-10  rounded-3xl bg-gray-950/5 px-4 py-8 ring-1 ring-neutral-700/10 dark:bg-neutral-900/60">
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="space-y-3 text-center">
            ...
            words={[
              {
                text: 'AI ',
                className:
                  'font-manga tracking-wide text-amber-400 drop-shadow-[0_0_14px_rgba(251,191,36,0.45)]',
              },
              {
                text: 'MANGA ',
                className:
          ...
          >
            Turn simple prompts into full manga pages. Maintain character
            consistency, control panel layouts, and export chapters as
            print‑ready PDFs – all in one focused studio.
          </p>
