          ...
          {!selectedElement ? (
            ...
            <>
              ...
              {(selectedElement.type === 'text' ||
                ...
                <TextProperties
                  element={selectedElement as TextElement | DialogueElement}
                />
              )}
...
function TextProperties({
  ...
  element: TextElement | DialogueElement;
}) {
              ...
              <button
                ...
                onClick={() =>
                  updateElement(element.id, {
                    textAlign: opt.value as 'left' | 'center' | 'right',
                  })
                }
                className={cn(
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <Slider
            ...
            onValueChange={([value]) =>
              updateElement(element.id, { strokeSize: value })
            }
            min={0}
            max={10}
            step={1}
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              updateElement(element.id, { hasTail: checked })
            }
          />
        </div>
          ...
          <>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-zinc-400">
                  {element.tailAngle.toFixed(2)}
                </span>
              </div>
              <Slider
                value={[element.tailAngle]}
                onValueChange={([value]) =>
                  updateElement(element.id, { tailAngle: value })
                }
                min={0}
                max={1}
                step={0.01}
            ...
            <div className="space-y-2">
              ...
              <Slider
                ...
                onValueChange={([value]) =>
                  updateElement(element.id, { tailLength: value })
                }
                min={10}
                max={100}
                step={1}
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          onValueChange={([value]) =>
            updateElement(element.id, { borderWidth: value })
          }
          min={0}
          max={10}
          step={1}
