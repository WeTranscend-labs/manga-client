                      ...
                      return (
                        <div key={idx} className="relative group h-20 w-full">
                          ...
                          <button
                            ...
                            title={
                              enabled
                                ? 'Disable (will be saved but not used)'
                                : 'Enable (will be used in generation)'
                            }
                          >
                            {enabled && (
                              <svg
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                <span>Art Style</span>
                {config.style &&
                  (config.style.includes('Webtoon') ||
                    config.style.includes('Manhwa') ||
                    config.style.includes('Digital')) && (
                    <span className="text-[9px] text-zinc-500 font-normal normal-case">
                      Modern
                    </span>
                  )}
              ...
              <Select
                value={config.style}
                onValueChange={(value) =>
                  onConfigChange({ ...config, style: value as MangaStyle })
                }
              >
                ...
                <SelectContent className="bg-zinc-950 border-zinc-800 font-sans max-h-[300px]">
                  ...
                  {['Shonen', 'Shoujo', 'Seinen', 'Josei'].map((s) => (
                    <SelectItem
                      key={s}
                      value={s}
                      className="text-xs text-zinc-300 hover:bg-zinc-800 focus:bg-zinc-800 focus:text-white cursor-pointer"
                    >
                      {s}
                    </SelectItem>
                  ))}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  value={config.inking}
                  onValueChange={(value) =>
                    onConfigChange({ ...config, inking: value as InkingStyle })
                  }
                >
                  <SelectTrigger className="w-full bg-zinc-950 border-zinc-800 text-zinc-300 hover:border-amber-500 focus:border-amber-500 h-9 text-xs">
                    <SelectValue />
                  ...
                  <SelectContent className="bg-zinc-950 border-zinc-800 max-h-[300px]">
                    ...
                    {['G-Pen', 'Tachikawa Pen', 'Brush Ink', 'Marker'].map(
                      (s) => (
                        <SelectItem
                          key={s}
                          value={s}
                          className="text-xs text-zinc-300 hover:bg-amber-500/20 focus:bg-amber-500/20 focus:text-white cursor-pointer"
                        >
                          {s}
                        </SelectItem>
                      ),
              ...
              <div className="space-y-2">
                <label
                  className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider flex items-center gap-1"
                  style={{ fontFamily: 'var(--font-inter)' }}
                >
                  ...
                  {config.style &&
                    (config.style.includes('Webtoon') ||
                      config.style.includes('Manhwa') ||
                      config.style.includes('Digital')) &&
                    config.screentone !== 'None' && (
                      <span className="text-[8px] text-zinc-500 font-normal normal-case">
                        None
                      </span>
                    )}
                </label>
                <Select
                  ...
                  onValueChange={(value) =>
                    onConfigChange({
                      ...config,
                      screentone: value as ScreentoneDensity,
                    })
                  }
                >
                  <SelectTrigger className="w-full bg-zinc-950 border-zinc-800 text-zinc-300 hover:border-amber-500 focus:border-amber-500 h-9 text-xs">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <span className="text-[9px] text-zinc-500 font-normal normal-case">
                  (Choose manga page style)
                </span>
              </label>
              <Select
                value={config.layout}
                onValueChange={(value) =>
                  onConfigChange({ ...config, layout: value as PanelLayout })
                }
              >
                <SelectTrigger className="w-full bg-zinc-950 border-zinc-800 text-zinc-300 hover:border-amber-500 focus:border-amber-500 h-9 text-xs">
                  <SelectValue />
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    onConfigChange({
                      ...config,
                      dialogueDensity: value as DialogueDensity,
                    })
                  }
                >
                  <SelectTrigger className="w-full bg-zinc-950 border-zinc-800 text-zinc-300 hover:border-amber-500 focus:border-amber-500 h-9 text-xs">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    onConfigChange({ ...config, language: value as Language })
                  }
                >
                  <SelectTrigger className="w-full bg-zinc-950 border-zinc-800 text-zinc-300 hover:border-amber-500 focus:border-amber-500 h-9 text-xs">
                    <SelectValue />
            ...
            <div className="space-y-2 pt-2 border-t border-zinc-800">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <label
                    className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider flex items-center gap-2"
                    style={{ fontFamily: 'var(--font-inter)' }}
                  >
                  ...
                  <p
                    ...
                    style={{ fontFamily: 'var(--font-inter)' }}
                  >
                    AI tự động tiếp tục câu chuyện từ page trước (không cần viết
                    prompt mới)
                  </p>
                </div>
                <button
                  onClick={() =>
                    onConfigChange({
                      ...config,
                      autoContinueStory: !config.autoContinueStory,
                    })
                  }
                  className={`ml-3 relative w-14 h-7 rounded-full transition-all ${config.autoContinueStory ? 'bg-zinc-600' : 'bg-zinc-700'}`}
                >
                  <div
                    className={`absolute top-1 left-1 w-5 h-5 bg-white rounded-full transition-transform ${config.autoContinueStory ? 'translate-x-7' : 'translate-x-0'}`}
                  />
                </button>
              </div>
              ...
              {config.autoContinueStory && (
                <div className="space-y-2 mt-3">
                  ...
                  >
                    ...
                    <span className="text-[9px] text-zinc-500 font-normal normal-case">
                      (Optional: Guide auto-continue flow)
                    </span>
                  </label>
                  <textarea
                    ...
                    onChange={(e) => {
                      try {
                        onConfigChange({
                          ...config,
                          storyDirection: e.target.value,
                        });
                      } catch (error) {
                        console.error(
                          'Error in storyDirection onChange:',
                          error,
                        );
                      }
                    }}
